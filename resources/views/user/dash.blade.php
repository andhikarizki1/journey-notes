...
<div class="row justify-content-center mt-3">
    ...
    <div class="col-md-8">
        ...
        <ul class="nav nav-pills mb-3 mt-3" id="pills-tab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Catatan Perjalanan</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="pills-isi-tab" data-bs-toggle="pill" data-bs-target="#pills-isi" type="button" role="tab" aria-controls="pills-isi" aria-selected="false">Isi Data Perjalanan</button>
            </li>
            <li class="nav-item" role="presentation">
